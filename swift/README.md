# whisp — native Swift app (Phase 1)
...
.build/release/whisp                    # default: gemma3:4b, light cleanup
.build/release/whisp --cleanup off      # raw transcript, fastest
.build/release/whisp --model llama3.1:latest
.build/release/whisp --hotkey cmd_r     # alt_r (default) | cmd_r | ctrl_r
```
...
```bash
.build/release/whisp --selftest ../bench/audio/fillers.wav
```
